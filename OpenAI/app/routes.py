...
def questions():
    ...
    prompt =  f"""
    Generate a series of multiple-choice security awareness questions focused on cloud security and data privacy for a leader-board style competition in the context of a National Research and Education Network (NREN). The questions should be provided in valid JSON format, with the following fields:
    ...
    Department: The specific department the question is targeting, e.g., “Systems and Software Department”, “Networks Department”, "Audit Department", "HR Department", "Finance Department".
